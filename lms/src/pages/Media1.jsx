...
const Media1 =()=>{
    return(
        <div>
            <Blackdiv title={'Naat Shareef'} />
            <div className='flex flex-col justify-center mt-16 mb-10'>
                <h1 className='text-3xl md:text-4xl lg:text-5xl font-bold flex justify-center items-center text-green-900 mt-10 mb-10'>NAATS</h1>
